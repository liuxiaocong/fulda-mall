...
class setAddressPageView extends React.Component {
    ...
    constructor( props ) {
        ...
        this.state = {
            text: this.props.user.address ? this.props.user.address : '',
    ...
    onTapSave() {
        ...
        if ( !this.state.text || this.state.text.length <= 0 ) {
            this.setState( { error: I18n.t( Keys.plz_input_address ) } );
            return;
        }

        this.setState( { isRequesting: true, error: '' } );
        this.props.onTapSave( this.state.text, ( err, resBody ) => {
        ...
        return (
            <View
                ...
                <PlaceInputComponent
                    ...
                    placeholder={I18n.t( Keys.plz_input_address )}
                    maxLength={UtilConfig.MAX_LENGTH.USER_ADDRESS}
...
export default setAddressPageView;
