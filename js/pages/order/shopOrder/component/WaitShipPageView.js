...
class WaitShipPageView extends React.Component {
            ...
            <View>
                ...
                <View style={
                    ...
                    <TouchableOpacity
                        style={[ styles.actionButton ]}
                        onPress={() => {
                            this.confirmShipping( item.buyer.name, item.id )
                        }}>
                        <Text style={[ styles.actionText ]}>
                            {I18n.t( Keys.ship_goods )}
                        </Text>
                    </TouchableOpacity>
                </View>
    ...
    confirmShipping = ( buyerName, orderId ) => {
        //noinspection JSCheckFunctionSignatures
        Alert.alert(
            I18n.t( Keys.shipping ),
            I18n.t( Keys.confirm_already_shipping ) + "[" + buyerName + "]",
            [
                { text: I18n.t( Keys.cancel ), onPress: () => console.log( 'cancel' ), style: 'cancel' },
                {
                    ...
                    this.props.confirmShipping( orderId, ( err, resBody ) => {
