...
class WaitConfirmPageView extends React.Component {
            ...
            <View>
                ...
                <View style={
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            this.confirmOrder( item.shop.name, item.id )
                        }}>
                        <Text style={[ styles.actionText ]}>
                            {I18n.t( Keys.confirm_order )}
                        </Text>
                    </TouchableOpacity>
                </View>
    ...
    confirmOrder = ( orderName, orderId ) => {
        //noinspection JSCheckFunctionSignatures
        Alert.alert(
            I18n.t( Keys.confirm ),
            I18n.t( Keys.confirm_to_receive_order ) + "[" + orderName + "]",
            [
                { text: I18n.t( Keys.cancel ), onPress: () => console.log( 'cancel' ), style: 'cancel' },
                {
                    text: I18n.t( Keys.confirm ), onPress: () => {
                    this.setState( { isRequesting: true } );
                    this.props.confirmReceive( orderId, ( err, resBody ) => {
                        ...
                        isEmpty ?
                            <View
                                ...
                                <Text style={commonStyles.emptyTipStyle}>
                                    {I18n.t( Keys.empty_wait_confirm_order )}
                                </Text>
                            </View>
                            :
                            <FlatList
...
export default WaitConfirmPageView;
