...
import { paymentTransactionPointList } from "../../../actions/PaymentAction";
...
class FRCRecordListComponent extends React.Component {
    static propTypes = {
        ...
        return (
            <View style={[ {
                    ...
                    <View>
                        <View style={[ { flexDirection: 'row' } ]}>
                            <View style={[ commonStyles.wrapper ]}>
                                {FRCRecordListComponent.renderContent( I18n.t( Keys.trade_type ), item.typeText, 0 )}
                                {FRCRecordListComponent.renderContent( I18n.t( Keys.trade_reason ), '' + item.reason, 10 )}
                                {FRCRecordListComponent.renderContent( I18n.t( Keys.create_time ), Util.getDateDescription( item.transactionDate ), 10 )}
                                {FRCRecordListComponent.renderContent( I18n.t( Keys.stop_time ), I18n.t( Keys.null ), 10 )}
                            </View>
                        ...
                        {FRCRecordListComponent.renderContent( I18n.t( Keys.trade_order_number ), item.reference, 10 )}
                    </View>
                </View>
                ...
                <View style={[ commonStyles.wrapper, {
                    ...
                    {FRCRecordListComponent.renderContent( I18n.t( Keys.money ), Util.getShowPrice( this.props.user.currency, item.pointBalance ), 0 )}
                    {FRCRecordListComponent.renderContent( I18n.t( Keys.cost ), Util.getShowPrice( this.props.user.currency, item.fee ), 10 )}
                </View>
            </View>
        );
    }
                    ...
                    isEmpty ?
                        <View
                            ...
                            <Text style={commonStyles.emptyTipStyle}>
                                {I18n.t( Keys.empty_fulda_record )}
                            </Text>
                        </View>
                        :
                        <FlatList
...
export default  connect( select )( FRCRecordListComponent );