...
class WalletTransferSuccessPage extends React.Component {
            ...
            <View
                ...
                <View style={[ commonStyles.justAlignCenter ]}>
                    ...
                    <Text style={[ { marginTop: 40, fontSize: 16 }, commonStyles.commonTextColorStyle ]}>
                        {I18n.t( Keys.transfer_success )}
                    </Text>

                    <Text style={[ { fontSize: 14, color: '#717789', marginTop: 30, } ]}>
                        {format(
                            I18n.t( Keys.you_have_transfer_to_some_one ),
                            this.state.user.name,
                            Util.getDisplaySymbol( this.state.useFromMemberCurrency ? this.state.userMe.currency : this.state.user.currency ) +
...
export default  connect( select )( WalletTransferSuccessPage );
